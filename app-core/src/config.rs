...
pub struct AppConfig {
    ...
    pub practice_live_trace_offset_ms: Option<f64>,
    pub usdx_lyric_display_offset_ms: Option<f64>,
    pub playback_volume: Option<f64>,
    pub playback_keybindings: Option<HashMap<String, String>>,
}
...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            ...
            practice_live_trace_offset_ms: None,
            usdx_lyric_display_offset_ms: None,
            playback_volume: None,
            playback_keybindings: None,
        }
    }
}
